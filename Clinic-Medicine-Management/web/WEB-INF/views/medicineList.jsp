...
<head>
    ...
    <script src="js/medicineList.js"></script>
</head>
<body>
<%-- 导航栏--%>
...
<div class="form-group">
    ...
    <div class="col-lg-3" style="display: inline-block">
        <input type="text" class="form-control" placeholder="输入药品名称/编码/生产厂家">
    </div>

    <div class="col-sm-6">
        <label class="control-label">处方类别</label>
        <select class="form-control" style="width: 150px;display: inline-block;margin-right: 50px">
            <option>1</option>
            <option>2</option>
            <option>3</option>
            <option>4</option>
...
<%-- 分页栏 --%>
    <div align="center">
        <ul class="pagination pagination-lg">
            <li><a href="medicine?pageNo=${request.page.pageNo-1}">&laquo;</a></li>
            <s:iterator begin="1" end="#request.page.totalPageCount" var="currPageNo">
                <li><a href="medicine?pageNo=${currPageNo}">${currPageNo}</a></li>
            </s:iterator>
            <li><a href="medicine?pageNo=${request.page.pageNo+1}">&raquo;</a></li>
        </ul>
    </div>
</body>
</html>
